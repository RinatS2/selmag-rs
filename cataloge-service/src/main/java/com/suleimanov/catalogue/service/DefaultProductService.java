...
public class DefaultProductService implements ProductService {
    ...
    private final ProductRepository productRepository; //внедрение зависимости. Лучше внедрять интерфейсы для того, чтобы можно было заменить одну реализацию на другую
